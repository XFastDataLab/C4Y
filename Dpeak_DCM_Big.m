...
%集中式聚类
%d 范围 k聚类个数
d = 0.16;     % d= 0.2    d=0.275    d=0.12   k=13
k = 13;       % k=11      k=7
...
figure(),drawshapes3d(norm_Allcenters,norm_Allcenters_idx,5500);
figure(),drawshapes3d(ori_Allcenters,ori_Allcenters_idx,5500);
